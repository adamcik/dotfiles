...
echo Remeber to run: aptitude install apt-file awesome bind9-host build-essential dnsutils git i3 ipython less mosh rxvt-unicode screen vim xfonts-terminus zsh
